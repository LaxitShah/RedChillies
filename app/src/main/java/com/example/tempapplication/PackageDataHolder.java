...
public class PackageDataHolder {


    String caterer_id,package_id,package_name,package_price,package_event_name,package_image,package_desc;
    ...
    public String getPackage_event_name() {
        return package_event_name;
    }

    public void setPackage_event_name(String package_event_name) {
        this.package_event_name = package_event_name;
    }
